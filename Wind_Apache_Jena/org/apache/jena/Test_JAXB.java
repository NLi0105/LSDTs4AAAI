...
public class Test_JAXB {
    public static void main(String[] args) throws JAXBException {
        ...
        TurbineSpecs turbineSpecs = (TurbineSpecs) turbineUnmarshaller.unmarshal(new File("project_folder/Wind/src/main/java/Specifications/turbineSpecs.xml"));
...
//        turbineSpecs.setGeometry(point);
        ...
        WindFarmSpecs windFarmSpecs = (WindFarmSpecs) windFarmUnmarshaller.unmarshal(new File("project_folder/Wind/src/main/java/Specifications/windFarmSpecs.xml"));
