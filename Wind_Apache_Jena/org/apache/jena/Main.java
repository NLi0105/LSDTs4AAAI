...
//        OntModel model = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM_RULE_INF);
        ...
        // Create geometries
        String filePath = "project_folder/GeoSpatial_manual.wkt";
...
//                "(?t <http://windfarm/Turbine#hasRotorConeAngle> ?theta)" +
//                "greaterThan(?theta, 10)" +
//                "->" +
//                "(?t <http://windfarm/Turbine#hasNEW> true)]";
//
...
//
        String rulesFilePath = "project_folder/Wind/src/main/java/Rules/Rules_backup.txt";
//        String rulesFilePath = "project_folder/Wind/src/main/java/Rules/RulesSyn.text";
