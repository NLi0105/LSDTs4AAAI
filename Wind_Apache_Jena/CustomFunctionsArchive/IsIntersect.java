...
public class IsIntersect extends BaseBuiltin {
    ...
    public boolean bodyCall(Node[] args, int length, RuleContext context) {
        ...
        if (args.length < 2) {
            throw new IllegalArgumentException("IsIntersect requires at least 2 arguments");
        }
        ...
        if (geomNode1.isLiteral() && geomNode2.isLiteral() &&
            ...
            try {
                ...
                boolean isIntersect = geom1.intersects(geom2);
                Node result = NodeFactory.createLiteralByValue(isIntersect, XSDDatatype.XSDboolean);
