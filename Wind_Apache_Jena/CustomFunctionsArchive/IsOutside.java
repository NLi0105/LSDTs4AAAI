...
public class IsOutside extends BaseBuiltin {
    ...
    public boolean bodyCall(Node[] args, int length, RuleContext context) {
        ...
        if (args.length < 2) {
            throw new IllegalArgumentException("IsOutside requires at least 2 arguments");
        }
        ...
        if (geomNode1.isLiteral() && geomNode2.isLiteral() &&
            ...
            try {
                ...
                boolean isOutside = geom2.disjoint(geom1);
                Node result = NodeFactory.createLiteralByValue(isOutside, XSDDatatype.XSDboolean);
