...
public class HurricaneListener_full extends StatementListener {
    ...
    public HurricaneListener_full(Model model) {
        this.model = model;
    ...
    private boolean isArrivalTimeWithin24Hours(Resource hurricane) {
        ...
        if (arrivalTimeStmt != null && arrivalTimeStmt.getObject().isLiteral() && currentTimeStmts.hasNext()) {
            try {
                ...
                System.out.println("Difference in Hours: " + diffInHours + ", hurricane is in effect.");
