...
4.  **Format as JSON:** Structure all extracted information into a single, valid JSON object according to the schema below.
  ...
  "project_constraints": [
    {
      ...
      "linked_component_ids": [
        "Array of component_id(s) this constraint applies to. Use [] for project-wide constraints."
      ],
